       ...
       {languages.map((lang, index) => (     
        <label key={index} className='flex space-x-2'>           
          <input
           ...
           <div className="w-6 h-6 border-2 border-violet-700 rounded-full flex items-center justify-center bg-white hover:bg-violet-200 transition-colors duration-300">
           ...
           <button
            ...
            onClick={generateTranslation}>Translate
           </button>
        </div>
      </div>
    )
